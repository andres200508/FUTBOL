...
boton3 = tkinter.Button(f1, text = "AZAR", width = 10, height = 5, command=partial(elegir_dificultad, 2), bg="magenta")
boton4 = tkinter.Button(f1, text = "Dificil", width = 10, height = 5, command=partial(elegir_dificultad, 3), bg="darkgoldenrod1")
boton5 = tkinter.Button(f1, text = "Imposible", width = 10, height = 5, command=partial(elegir_dificultad, 4), bg="orangered2")
