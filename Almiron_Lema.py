...
boton1 = tkinter.Button(f1, text = "Facil", width = 10, height = 5, command=partial(elegir_dificultad, 0))
boton2 = tkinter.Button(f1, text = "Medio", width = 10, height = 5, command=partial(elegir_dificultad, 1))
boton3 = tkinter.Button(f1, text = "Dificil", width = 10, height = 5, command=partial(elegir_dificultad, 2))
boton4 = tkinter.Button(f1, text = "Imposible", width = 10, height = 5, command=partial(elegir_dificultad, 3))



etiqueta = tkinter.Label(f2, text = "Ingrese su nombre", bg = "light blue")
nombre = tkinter.Entry(f2, text = "Nombre de usuario")
empezar = tkinter.Button(f3, text = "Presione Para Iniciar")
